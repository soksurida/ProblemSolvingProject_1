                ...
                <div className="payment-form-grid">
                  ...
                  <div className="address-group">
                    <input
                      ...
                      placeholder="주소 검색"
                    />
                    <button className="zipcode-btn" onClick={() => setIsPostOpen(true)}>
                      우편번호 찾기
                    </button>
                  </div>
                  <label>상세주소</label>
                  <input
                    ...
                    onChange={(e) => setReceiverInfo({ ...receiverInfo, detail: e.target.value })}
                    placeholder="상세주소 입력"
                  />
                </div>
              </section>
              ...
              <section className="payment-section-box">
                ...
                <div className="payment-methods">
                  {[
                    ...
                    <button
                      key={method}
                      className={selectedPayment === method ? 'selected-payment' : ''}
